...
public class Directory extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (ajax) {
            ...
            options.put("parentPath", isChild && childPath.getParent() != null ? URLEncoder.encode(File.separator + rootPath.relativize(childPath.getParent()).toString(), "UTF-8") : File.separator);
